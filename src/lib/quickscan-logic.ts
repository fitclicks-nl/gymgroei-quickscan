...
export const quickscanQuestions: QuickscanQuestion[] = [
  ...
  },
  {
    ...
    domain: "Instroom",
    statement:
      "Mijn marketing levert regelmatig nieuwe leads op.",
  },
  {
    id: 14,
    domain: "Instroom",
    statement:
      "Mensen kunnen makkelijk contact opnemen of zich aanmelden.",
  },
  {
    id: 15,
    domain: "Instroom",
  ...
  },
  {
    ...
    domain: "Conversie",
    statement:
      "Ik weet waar leads afhaken tussen aanvraag en inschrijving.",
  },
  ...
  },
  {
    ...
    domain: "Sturing",
    statement:
      "Ik weet welke cijfers belangrijk zijn voor mijn groei.",
  },
  {
    id: 23,
    domain: "Sturing",
    statement:
      "Ik kijk regelmatig naar mijn cijfers en resultaten.",
  },
  {
    id: 24,
    domain: "Sturing",
    statement:
      "Ik gebruik mijn cijfers om beslissingen te nemen.",
  },
  {
    id: 25,
    domain: "Sturing",
    statement:
      "Ik weet waar ik moet bijsturen als resultaten tegenvallen.",
  },
];
...
> = {
    ...
    actions: [
      {
        ...
        why:
          "Deze groep is groot, maar reageert alleen als ze zich écht begrepen voelen.",
        result:
      ...
      },
      {
        ...
        result:
          "Meer vertrouwen en een lagere instapdrempel.",
      },
      {
    ...
    actions: [
      {
        ...
        result:
          'Meer mensen die denken: "dit past bij mij".',
      },
      {
        ...
        result:
          "Minder twijfel en een sterkere eerste indruk bij nieuwe leads.",
      },
      {
        ...
        result:
          "Minder prijsvergelijking en meer keuze op basis van waarde.",
      },
    ],
    avoid:
    ...
    actions: [
      {
        ...
        result:
          "Meer voorspelbaarheid in het aantal leads.",
      },
      {
      ...
      },
      {
        ...
        result:
          "Meer leads uit hetzelfde bereik.",
      },
    ],
    avoid:
  ...
  Conversie: {
    summary:
      "Op dit moment laat je vooral resultaat liggen in wat er gebeurt ná een lead. De kans is groot dat je wel leads binnenkrijgt, maar dat te veel mensen afhaken tussen eerste contact en inschrijving. Daardoor voelt het alsof je meer leads nodig hebt, terwijl de grootste winst zit in wat je al binnenkrijgt.",
    ...
    actions: [
      {
        ...
        result:
          "Meer mensen die verschijnen én betere gesprekken tijdens de intake.",
      },
      {
        ...
        result:
          "Meer afspraken uit hetzelfde aantal leads.",
      },
      {
        ...
        result:
          "Je weet precies waar je moet verbeteren.",
      },
    ],
    avoid:
    ...
    actions: [
      {
        ...
        result:
          "Meer grip op je groei, ongeacht hoe je het bijhoudt.",
      },
      {
        ...
        result:
          "Betere beslissingen en minder twijfel.",
      },
      {
        ...
        result:
          "Gerichte verbeteringen die echt effect hebben.",
      },
    ],
    avoid:
...
export function calculateQuickscanScores(
  ...
  const scores = {
    ...
    Conversie: 0,
    Sturing: 0,
  } as Record<QuickscanDomain, number>;
...
export function generateQuickscanResult(answers: number[]): QuickscanResult {
  ...
  // Instroom
  {
    id: 11,
    domain: "Instroom",
    statement: "Ik krijg structureel nieuwe aanvragen binnen.",
  },
  {
    id: 12,
    domain: "Instroom",
  ...
  },
  {
    ...
    domain: "Instroom",
    statement:
      "Mijn marketing levert regelmatig nieuwe geïnteresseerden op.",
  },
  {
    id: 14,
    domain: "Instroom",
  ...
  // Conversie
  {
    id: 16,
    domain: "Conversie",
    statement: "De meeste aanvragen leiden tot een afspraak of intake.",
  },
  {
    id: 17,
    domain: "Conversie",
  ...
  },
  {
    id: 18,
    domain: "Conversie",
    statement: "Een groot deel van de geïnteresseerden wordt uiteindelijk lid.",
  },
  {
    id: 19,
    domain: "Conversie",
    statement: "Ik volg nieuwe aanvragen snel en consequent op.",
  },
  {
    id: 20,
    domain: "Conversie",
    statement:
      "Ik weet waar mensen afhaken tussen aanvraag en inschrijving.",
  },
  ...
  // Sturing
  {
    ...
    domain: "Sturing",
    statement:
      "Ik heb duidelijk overzicht van mijn aanvragen, afspraken en nieuwe leden.",
  },
  {
    id: 22,
    domain: "Sturing",
...
> = {
  "Doelgroep & Focus": {
    ...
    avoid:
      'Blijf je marketing niet richten op "iedereen die wil sporten" of vooral op fitte mensen. Daarmee spreek je vooral mensen aan die de stap toch al zouden zetten.',
  },
  Positionering: {
    summary:
      "Op dit moment is het voor een potentiële klant niet direct duidelijk waarom hij juist voor jouw gym moet kiezen. De kans is groot dat je vooral laat zien wat je hebt, zoals apparatuur, lessen of de ruimte. Dat draagt bij aan de beleving, maar is zelden de reden waarom iemand de stap zet om te beginnen. Juist herkenning en gevoel maken het verschil.",
    ...
    actions: [
      ...
      },
      {
        title: "Zorg dat jouw verhaal overal hetzelfde voelt",
        what:
          "Laat website, socials, advertenties en clubbeleving hetzelfde gevoel en dezelfde boodschap uitstralen.",
        why:
          "Als online beeld en echte ervaring overeenkomen, ontstaat direct vertrouwen.",
        result:
          "Minder twijfel en een sterkere eerste indruk bij nieuwe leads.",
  ...
  Instroom: {
    summary:
      "Je instroom van nieuwe leads is op dit moment niet stabiel genoeg om structureel te groeien. Waarschijnlijk heb je wel momenten waarop er aanvragen binnenkomen, maar dit is niet iets waar je op kunt rekenen. Groei blijft daardoor afhankelijk van acties, seizoenen of toeval.",
    priorityTitle: "Jouw grootste aandachtspunt: Instroom",
    actions: [
      {
        title: "Zorg voor één vaste manier om nieuwe leads te krijgen",
        what:
          "Kies één kanaal of aanpak waarmee je structureel aanvragen wilt genereren en focus daar eerst op.",
        why:
          "Zolang je afhankelijk bent van losse dingen, bouw je nergens echt volume op.",
        result:
          "Meer voorspelbaarheid in het aantal aanvragen.",
      },
      {
        title: "Werk met een instapaanbod dat leidt tot echte betrokkenheid",
        what:
      ...
      },
      {
        ...
        why:
          "Hoe meer stappen iemand moet zetten, hoe groter de kans dat hij afhaakt.",
        result:
          "Meer aanvragen uit hetzelfde bereik.",
      },
    ],
    avoid:
      "Blijf niet werken met losse proeflessen of korte acties zonder vervolg en begeleiding. Dat levert wel interesse op, maar te weinig binding.",
  ...
  Conversie: {
    summary:
      "Op dit moment laat je vooral resultaat liggen in wat er gebeurt ná een aanvraag. De kans is groot dat je wel leads binnenkrijgt, maar dat te veel mensen afhaken tussen eerste contact en inschrijving. Daardoor voelt het alsof je meer leads nodig hebt, terwijl de grootste winst zit in wat je al binnenkrijgt.",
    priorityTitle: "Jouw grootste aandachtspunt: Conversie",
    actions: [
      {
        title: "Maak je intake concreet en duidelijk vooraf",
      ...
      },
      {
        title: "Zorg voor snelle en consistente opvolging",
        what:
          "Reageer snel op nieuwe aanvragen en werk met een vaste manier van opvolgen.",
        why:
          "De eerste uren na een aanvraag bepalen vaak of iemand bij jou instapt of ergens anders.",
        result:
          "Meer afspraken uit hetzelfde aantal leads.",
      },
      {
        title: "Breng in kaart waar mensen afhaken",
        what:
          "Kijk stap voor stap waar mensen afhaken: na aanvraag, na eerste contact, na intake of na een proefperiode.",
        why:
          "Vaak verlies je op één specifiek punt de meeste mensen, zonder dat je dat doorhebt.",
        result:
          "Je weet precies waar je moet verbeteren.",
    ...
    actions: [
      {
        title: "Maak je proces inzichtelijk op jouw manier",
        what:
          "Zorg dat je overzicht hebt van aanvragen, afspraken en nieuwe leden in een systeem, sheet of handmatig, zolang het maar duidelijk en consistent is.",
        why:
          "Zonder overzicht weet je niet waar je winst laat liggen.",
        result:
          "Meer grip op je groei, ongeacht hoe je het bijhoudt.",
      ...
      },
      {
        title: "Gebruik je inzicht om bij te sturen",
        what:
          "Koppel je overzicht direct aan acties. Weinig aanvragen vraagt iets anders dan veel aanvragen maar weinig leden.",
        why:
          "Zo voorkom je dat je overal tegelijk aan gaat sleutelen.",
        result:
          "Gerichte verbeteringen die echt effect hebben.",
