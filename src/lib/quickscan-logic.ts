...
export const likertOptions = [
  { label: "Helemaal oneens", value: 1 },
  { label: "Oneens", value: 2 },
  { label: "Neutraal", value: 3 },
  { label: "Eens", value: 4 },
  { label: "Helemaal eens", value: 5 },
];
...
export const quickscanQuestions: QuickscanQuestion[] = [
  ...
  },
  {
    id: 4,
    domain: "Doelgroep & Focus",
    statement: "Ik trek vooral mensen aan die goed passen bij mijn gym.",
  },
  {
    id: 5,
    domain: "Doelgroep & Focus",
    statement: 'Mijn marketing is niet gericht op "iedereen die wil sporten".',
  },
